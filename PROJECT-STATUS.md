...
L'**étape 1 du CDC v1.3 est livrée et déployée**, enrichie par 8 vagues post-livraison (CDC v1.5 + chantiers métier mai 2026 + retours coordonnateurs juin 2026 + réunion direction 1ᵉʳ juillet 2026). La maquette est fonctionnelle, accessible sur URL publique avec Basic Auth, et tous les flux pédagogiques sont testés en bout-en-bout : **673 tests unitaires + 204 tests E2E passent**, bundle JS gzippé ~184 KB. Aucune authentification réelle ni backend persistant pour l'instant — c'est précisément l'objet de l'étape 2.
...
| État des tests (673 unit + 204 E2E)                             | §6                                                                                                        |
...
| **Tests unitaires**   | **673 / 673 ✓** (Vitest, 47 fichiers de test)                                                    |
...
- Tests : **673 unitaires** (47 fichiers — +58 sur les 7 nouvelles libs du chantier #4, droits 52, validation-signature 24) ; **204 E2E / 28 specs** (nouveau `admin-activites.spec.ts` 8 scénarios ; `entretien-selection-competences` refondu en mode activités ; `sprint4` adapté à la provenance de la projection ; `admin-referentiels` recentré sur le BTS)
...
## 6. Tests (673 unitaires + 204 E2E)

### Tests unitaires Vitest (47 fichiers de test)
...
└── src/
    ...
    ├── lib/                        # 50 modules + 47 fichiers tests
