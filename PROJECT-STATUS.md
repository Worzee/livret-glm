...
_Étape 1 livrée + vagues post-livraison successives (CDC v1.5, chantiers métier mai-juillet 2026, demandes direction — dernière vague : réunion DG du 13 juillet 2026 : documents typés obligatoires, dépôt en masse par formation, responsables légaux des mineurs / 6ᵉ rôle). Prochaine étape : SSO Entra + gestion comptes/mots de passe (+ réexamen RGPD mineurs avec le DPO) — cf. §12._
