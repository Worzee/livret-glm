...
L'**étape 1 du CDC v1.3 est livrée et déployée**, enrichie par 8 vagues post-livraison (CDC v1.5 + chantiers métier mai 2026 + retours coordonnateurs juin 2026 + réunion direction 1ᵉʳ juillet 2026). La maquette est fonctionnelle, accessible sur URL publique avec Basic Auth, et tous les flux pédagogiques sont testés en bout-en-bout : **686 tests unitaires + 207 tests E2E passent**, bundle JS gzippé ~185 KB. Aucune authentification réelle ni backend persistant pour l'instant — c'est précisément l'objet de l'étape 2.
...
| **Tests unitaires**   | **686 / 686 ✓** (Vitest, 50 fichiers de test)                                                    |
| **Tests E2E**         | **207 / 207 ✓** (Playwright — Chromium desktop + mobile Pixel 5, 29 specs)                       |
...
## 6. Tests (686 unitaires + 207 E2E)

### Tests unitaires Vitest (50 fichiers de test)
...
└── src/
    ...
    ├── lib/                        # 53 modules + 50 fichiers tests
