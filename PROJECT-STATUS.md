...
L'**étape 1 du CDC v1.3 est livrée et déployée**, enrichie par 8 vagues post-livraison (CDC v1.5 + chantiers métier mai 2026 + retours coordonnateurs juin 2026 + réunion direction 1ᵉʳ juillet 2026). La maquette est fonctionnelle, accessible sur URL publique avec Basic Auth, et tous les flux pédagogiques sont testés en bout-en-bout : **767 tests unitaires + 220 tests E2E passent**, bundle JS gzippé ~185 KB. Aucune authentification réelle ni backend persistant pour l'instant — c'est précisément l'objet de l'étape 2.
...
└── src/
    ...
    │   ├── alertes.ts              # centre d'alertes par rôle (3 juillet) + points d'alerte entretien (8 juillet)
    ...
    │   ├── documents-administratifs.ts # documents nominatifs : visibilité, verrous, validation de dépôt (10 juillet)
