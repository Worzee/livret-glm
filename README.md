...
# Tests
npm test                  # 701 tests Vitest unit
npm run e2e               # 208 tests E2E Playwright (build + preview + tests)
...
├── e2e/                                                   ← 29 specs Playwright
└── src/
    ├── types/index.ts              ← modèle (CDC §7 + extensions v1.5)
    ├── lib/                        ← logique métier pure + 51 fichiers tests TDD
