...
# Tests
npm test                  # 515 tests Vitest unit
npm run e2e               # 157 tests E2E Playwright (build + preview + tests)
...
└── src/
    ...
    ├── lib/                        ← logique métier pure + 34 fichiers tests TDD
