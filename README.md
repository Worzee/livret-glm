...
# Tests
npm test                  # 686 tests Vitest unit
npm run e2e               # 207 tests E2E Playwright (build + preview + tests)
...
└── src/
    ...
    ├── lib/                        ← logique métier pure + 50 fichiers tests TDD
