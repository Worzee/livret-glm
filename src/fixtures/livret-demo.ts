...
export const livretLeaMartin: Livret = {
  ...
  organisationSuivi: {
    reunionRentree: '2025-09-04 — Salle Diderot',
    entretienIndividuel: 'À planifier',
    accueilTuteurs: '2025-09-15 — Journée tuteurs',
    visitesEntreprise: '2025-11-12, 2026-02-04, 2026-05-12 (prévue)',
    restitutionActivites: 'Tous les 6 semaines en classe',
    bilansFormation: 'Janvier et juin',
